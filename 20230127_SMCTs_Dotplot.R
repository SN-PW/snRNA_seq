...
PTS1_ctrl <- read.table("/Users/sakitakeshita/sn-RNAseq/1. Work on files/PTS1/SpeedTest_ctrl_PTS1のコピー.txt")
PTS1_4h <- read.table("/Users/sakitakeshita/sn-RNAseq/1. Work on files/PTS1/SpeedTest_4hours_PTS1のコピー.txt")
PTS1_12h <- read.table("/Users/sakitakeshita/sn-RNAseq/1. Work on files/PTS1/SpeedTest_12hours_PTS1のコピー.txt")
...
IRI <- ScaleData(IRI,features = c("Slc1a5"))
IRI <- RenameIdents(object = IRI, 'X4hours' = "4hours",  'X12hours' = "12hours")
levels(x = IRI) <- c("ctrl","4hours","12hours")

PTS2_ctrl <- read.table("/Users/sakitakeshita/sn-RNAseq/1. Work on files/PTS2/SpeedTest_ctrl_PTS2のコピー.txt")
PTS2_4h <- read.table("/Users/sakitakeshita/sn-RNAseq/1. Work on files/PTS2/SpeedTest_4hours_PTS2のコピー.txt")
PTS2_12h <- read.table("/Users/sakitakeshita/sn-RNAseq/1. Work on files/PTS2/SpeedTest_12hours_PTS2のコピー.txt")
...
IRI2<- ScaleData(IRI2,features = c("Slc1a5"))
IRI2 <- RenameIdents(object = IRI2, 'X4hours' = "4hours",  'X12hours' = "12hours")

levels(x = IRI2) <- c("ctrl","4hours","12hours")


PTS3_ctrl <- read.table("/Users/sakitakeshita/sn-RNAseq/1. Work on files/PTS3/SpeedTest_ctrl_PTS3のコピー.txt")
PTS3_4h <- read.table("/Users/sakitakeshita/sn-RNAseq/1. Work on files/PTS3/SpeedTest_4hours_PTS3のコピー.txt")
PTS3_12h <- read.table("/Users/sakitakeshita/sn-RNAseq/1. Work on files/PTS3/SpeedTest_12hours_PTS3のコピー.txt")
...
IRI3 <- ScaleData(IRI3, features = c("Slc1a5"))
